...
public class Exercise08_37 {
  public static void main(String[] args) {
    ...
    // Cast the states to a List for shuffling
    List<String[]> stateCapitals = Arrays.asList(stateCapital);
    ...
    for (int i = 0; i < stateCapital.length; i++) {
      ...
      // Allow quitting while still printing score
      if (capital.toLowerCase().equals("quit"))
        break;
